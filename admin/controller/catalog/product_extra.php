...
class ControllerCatalogProductExtra extends ControllerCatalogProduct {
	...
	public function __construct($arg){
		...
		$registry->set('customer', new CustomCustomer($registry));
  	...
  	public function index() {
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_tax_class"){
			$this->model_catalog_product_extra->changeTaxClass((int)$this->request->get['product_id'], (int)$this->request->get['tax_class_id']);
			echo "done";
			die();
		}
		
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_length_class"){
			$this->model_catalog_product_extra->changeLengthClass((int)$this->request->get['product_id'], (int)$this->request->get['length_class_id']);
			echo "done";
			die();
		}
		
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_stock_status"){
			$this->model_catalog_product_extra->changeStockStatus((int)$this->request->get['product_id'], (int)$this->request->get['stock_status_id']);
			echo "done";
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_subtract"){
			$this->model_catalog_product_extra->changeProductSubstract((int)$this->request->get['product_id']);
			echo "done";
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_sku"){
			echo $this->model_catalog_product_extra->changeProductSku((int)$this->request->get['product_id'], $this->request->get['sku']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_upc"){
			echo $this->model_catalog_product_extra->changeUpc((int)$this->request->get['product_id'], $this->request->get['upc']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_location"){
			echo $this->model_catalog_product_extra->changeLocation((int)$this->request->get['product_id'], $this->request->get['location']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_date_available"){
			echo $this->model_catalog_product_extra->changeDateAvailable((int)$this->request->get['product_id'], $this->request->get['date_available']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_seo"){
			echo $this->model_catalog_product_extra->changeSeo((int)$this->request->get['product_id'], $this->request->get['seo']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "update_description"){
			echo $this->model_catalog_product_extra->updateDescriptions((int)$this->request->get['product_id'], $this->request->post);
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_category"){
			$this->model_catalog_product_extra->changeProductCategory((int)$this->request->get['product_id'], $this->request->get['category_id']);
			echo "done";
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_meta_title"){
			echo $this->model_catalog_product_extra->changeMetaTitle((int)$this->request->get['product_id'], $this->request->get['meta_title'], $this->request->get['language']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_weight"){
			echo $this->model_catalog_product_extra->changeWeight((int)$this->request->get['product_id'], (float)$this->request->get['weight']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_weight_class"){
			echo $this->model_catalog_product_extra->changeWeightClass((int)$this->request->get['product_id'], (int)$this->request->get['weight_class_id']);
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_length"){
			echo $this->model_catalog_product_extra->changeLength((int)$this->request->get['product_id'], (float)$this->request->get['length']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_width"){
			echo $this->model_catalog_product_extra->changeWidth((int)$this->request->get['product_id'], (float)$this->request->get['width']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_height"){
			echo $this->model_catalog_product_extra->changeHeight((int)$this->request->get['product_id'], (float)$this->request->get['height']);
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_special"){
			echo $this->model_catalog_product_extra->changeProductSpecialPrice((int)$this->request->get['product_id'], (float)$this->request->get['price']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_discount"){
			echo $this->model_catalog_product_extra->changeProductDiscountPrice((int)$this->request->get['product_id'], (float)$this->request->get['price']);
			die();
		}
	...
	public function default_product(){
		$this->load->model('catalog/product_extra');
		$this->model_catalog_product_extra->setDefaultProduct();
		//echo "DONE";
	}
	...
	public function ajaxify(){
		if(isset($this->request->get['product_id']) && (int)$this->request->get['product_id'] > 0){
			...
			$list_weight_classes = $this->model_catalog_product_extra->getWeightClasses($data['selected_language']);
			$data['weight_classes'] = $list_weight_classes;
			$list_tax_classes = $this->model_catalog_product_extra->getTaxClasses();
			$data['tax_classes'] = $list_tax_classes;
			$list_stock_statuses = $this->model_catalog_product_extra->getStockStatuses($data['selected_language']);
			$data['stock_statuses'] = $list_stock_statuses;
			$list_length_classes = $this->model_catalog_product_extra->getLengthClasses($data['selected_language']);
			...
			$url = '';
			$data['link'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'];
			...
			foreach ($results as $result) {
				...
				$action[] = array(
					...
					'href' => 'index.php?route=catalog/product/edit&token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url
				);
				...
				$final_price = $this->model_catalog_product_extra->getFinalPrice($result['product_id'], $result['price'], $default_customer_group);
				if($final_price != ''){
				...
				$data['products'][] = array(
					...
					'keyword'    => $this->model_catalog_product_extra->getAlias($result['product_id']),
					'selected'   => isset($this->request->post['selected']) && in_array($result['product_id'], $this->request->post['selected']),
					'action'     => 'index.php?route=catalog/product/edit&token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url,
					...
					'descriptions'=>$this->model_catalog_product_extra->getDescriptions($result['product_id']),
					...
					'special_price'=>$this->model_catalog_product_extra->getMaxSpecialPrice($result['product_id']),
					'discount_price'=>$this->model_catalog_product_extra->getMaxDiscountPrice($result['product_id'])
				);
			}
	...
	private function specialPrices($product_id){
		...
		$this->response->setOutput($this->load->view('catalog/product_special_prices.tpl', $data));
	...
	protected function validateSpecialForm(){
  	...
  	protected function getList() {			
		...
		$data['insert'] = 'index.php?route=catalog/product/add&token=' . $this->session->data['token'] . $url;
		$data['copy'] = 'index.php?route=catalog/product/copy&token=' . $this->session->data['token'] . $url;	
		$data['delete'] = 'index.php?route=catalog/product/delete&token=' . $this->session->data['token'] . $url;
		...
		$product_total = $this->model_catalog_product_extra->getTotalProducts($filter_data);
		
		$results = $this->model_catalog_product_extra->getProducts($filter_data, (isset($_SESSION['product_language'])?$_SESSION['product_language']:$this->config->get('config_language_id')));
		//Get categories
		$this->load->model('catalog/category');
		$list_categories = array();
		$categories = $this->model_catalog_category->getCategories(0);
...
//extra
		$data['d_raid'] = $this->language->get('d_raid');
		$data['s_raid'] = $this->language->get('s_raid');
		$data['t_raid'] = $this->language->get('t_raid');
		$data['e_raid'] = $this->language->get('e_raid');
		$data['v_raid'] = $this->language->get('v_raid');
		$data['save_ch'] = $this->language->get('save_ch');
		...
		$data['sort_id'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.product_id' . $url;
		$data['sort_name'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=pd.name' . $url;
		$data['sort_meta_title'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=pd.meta_title' . $url;
		$data['sort_model'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.model' . $url;
		/*controller-hook-6*/
		$data['sort_quantity'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.quantity' . $url;
		$data['sort_weight'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.weight' . $url;
		$data['sort_status'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.status' . $url;
		$data['sort_subtract'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.subtract' . $url;
		$data['sort_sku'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.sku' . $url;
		$data['sort_upc'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.upc' . $url;
		
		$data['sort_location'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.location' . $url;
		$data['sort_date_available'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.date_available' . $url;
		$data['sort_order'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url;
		$data['sort_price'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.price' . $url;
		$data['sort_sort_order'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url;
		$data['sort_manufacturer'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=m.name' . $url;
		$data['sort_tax_class'] = 'index.php?route=catalog/product_extra&token=' . $this->session->data['token'] . '&sort=tc.title' . $url;
		...
		//$pagination->url = $this->url->link('catalog/product_extra', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/product_list_extra.tpl', $data));
  	}
}
