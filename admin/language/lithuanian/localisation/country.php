...
// Heading
$_['heading_title']           = 'Šalis';

// Text
$_['text_success']            = 'Pavyko: Jūs sėkmingai modifikavote šalis!';
...
$_['column_iso_code_2']       = 'ISO kosas (2)';
...
// Help
$_['help_address_format']     = 'Vardas = {firstname}<br />Pavardė = {lastname}<br />Įmonė = {company}<br />Adresas 1 = {address_1}<br />Adresas 2 = {address_2}<br />Miestas = {city}<br />Pašto kodas = {postcode}<br />Zona = {zone}<br />Zonos kodas = {zone_code}<br />Šalis = {country}';

// Error
$_['error_permission']        = 'Įspėjimas: Jūs neturite teisių modifikuoti šalis!';
...
$_['error_zone']              = 'Įspėjimas: Ši šalis negali būti pašalinta, nes ji priskirta %s zonoms!';
