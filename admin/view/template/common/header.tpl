...
<?php if(isset($_GET['iframed']) && $_GET['iframed'] == 1){?> 
  <link rel="stylesheet" type="text/css" href="view/stylesheet/product_extra.css" /> 
<?php }?>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img height="28" width="155"  src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
