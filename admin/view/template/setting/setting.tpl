        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-google">
              ...
              <fieldset>
                <legend><?php echo $entry_google_adwords; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_adwords; ?></div>
				 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-adwords"><?php echo $entry_google_adwords; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_google_adwords" rows="5" placeholder="<?php echo $entry_google_adwords; ?>" id="input-google-adwords" class="form-control"><?php echo $config_google_adwords; ?></textarea>
                </div>
              </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $entry_google_webmaster; ?></legend>
                ...
                <div class="col-sm-10">
                  <textarea name="config_google_webmaster" rows="5" placeholder="<?php echo $entry_google_webmaster; ?>" id="input-google-webmaster" class="form-control"><?php echo $config_google_webmaster; ?></textarea>
                </div>
              </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $entry_google_tagmanager; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_tagmanager; ?></div>
				 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-tagmanager"><?php echo $entry_google_tagmanager; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_google_tagmanager" rows="5" placeholder="<?php echo $entry_google_tagmanager; ?>" id="input-google-tagmanager" class="form-control"><?php echo $config_google_tagmanager; ?></textarea>
                </div>
              </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $entry_google_meta; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_meta; ?></div>
				 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-meta"><?php echo $entry_google_meta; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_google_meta" rows="5" placeholder="<?php echo $entry_google_meta; ?>" id="input-google-meta" class="form-control"><?php echo $config_google_meta; ?></textarea>
                </div>
              </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $entry_google_paysera_zenklas; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_paysera_zenklas; ?></div>
				 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-paysera_zenklas"><?php echo $entry_google_paysera_zenklas; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_google_paysera_zenklas" rows="5" placeholder="<?php echo $entry_google_paysera_zenklas; ?>" id="input-google-paysera_zenklas" class="form-control"><?php echo $config_google_paysera_zenklas; ?></textarea>
                </div>
              </div>
              </fieldset>
