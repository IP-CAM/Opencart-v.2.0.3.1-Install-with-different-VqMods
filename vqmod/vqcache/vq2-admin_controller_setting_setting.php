...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_google_adwords'] = $this->language->get('entry_google_adwords');
		$data['entry_google_webmaster'] = $this->language->get('entry_google_webmaster');
		$data['entry_google_meta'] = $this->language->get('entry_google_meta');
		$data['entry_google_paysera_zenklas'] = $this->language->get('entry_google_paysera_zenklas');
		$data['entry_google_tagmanager'] = $this->language->get('entry_google_tagmanager');
		...
		$data['help_google_adwords'] = $this->language->get('help_google_adwords');
		...
		$data['help_google_paysera_zenklas'] = $this->language->get('help_google_paysera_zenklas');
		$data['help_google_tagmanager'] = $this->language->get('help_google_tagmanager');
		$data['help_google_meta'] = $this->language->get('help_google_meta');
...
$data['config_meta_keyword'] =array();
		...
		if (isset($this->request->post['config_google_analytics_status'])) {
			...
			if (isset($this->request->post['config_google_adwords'])) {
			$data['config_google_adwords'] = $this->request->post['config_google_adwords'];
		} else {
			$data['config_google_adwords'] = $this->config->get('config_google_adwords');
		}
		...
		if (isset($this->request->post['config_google_meta'])) {
			$data['config_google_meta'] = $this->request->post['config_google_meta'];
		} else {
			$data['config_google_meta'] = $this->config->get('config_google_meta');
		}
		if (isset($this->request->post['config_google_paysera_zenklas'])) {
			$data['config_google_paysera_zenklas'] = $this->request->post['config_google_paysera_zenklas'];
		} else {
			$data['config_google_paysera_zenklas'] = $this->config->get('config_google_paysera_zenklas');
		}
		if (isset($this->request->post['config_google_tagmanager'])) {
			$data['config_google_tagmanager'] = $this->request->post['config_google_tagmanager'];
		} else {
			$data['config_google_tagmanager'] = $this->config->get('config_google_tagmanager');
		}
